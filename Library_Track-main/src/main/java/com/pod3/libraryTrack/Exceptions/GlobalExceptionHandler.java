...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ResponseStructure<String>> handleUserDeletionException(UserDeletionException ex) {
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
				.body(ResponseStructure.error(ex.getMessage(), ErrorMessages.USER_DELETION_FAILED));
	}
